...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 25 2018 г., 19:07
...
('def', 'weather', 'danye', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'weather', 'danye', 'date_pogod', 2, NULL, 'NO', 'varchar', 11, 33, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'weather', 'danye', 'name_gorod', 3, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'weather', 'danye', 'temperature', 4, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'weather', 'danye', 'pressure', 5, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'weather', 'danye', 'humidity', 6, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', '');
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '32'),
('HANDLER_READ_KEY', '9'),
('HANDLER_READ_LAST', '1'),
('HANDLER_READ_NEXT', '11'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '11'),
('HANDLER_READ_RND_NEXT', '2706'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2581'),
('INNODB_BUFFER_POOL_PAGES_DATA', '339'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '1'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7853'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3557'),
('INNODB_BUFFER_POOL_READS', '340'),
...
('INNODB_DATA_READ', '9850880'),
('INNODB_DATA_READS', '478'),
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'Z:\\usr\\local\\mysql-5.5\\share\\'),
...
('PID_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\Home-'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\Home-'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'Z:\\usr\\local\\mysql-5.5\\data\\Home-'),
...
('PLUGIN_DIR', 'Z:\\usr\\local\\mysql-5.5\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\Home-'),
...
('def', 'weather', 'PRIMARY', 'def', 'weather', 'danye', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'weather', 'PRIMARY', 'def', 'weather', 'danye', 'date_pogod', 2, NULL, NULL, NULL, NULL),
('def', 'weather', 'PRIMARY', 'def', 'weather', 'danye', 'name_gorod', 3, NULL, NULL, NULL, NULL),
('def', 'weather', 'PRIMARY', 'def', 'weather', 'danye', 'temperature', 4, NULL, NULL, NULL, NULL),
('def', 'weather', 'PRIMARY', 'def', 'weather', 'danye', 'pressure', 5, NULL, NULL, NULL, NULL),
('def', 'weather', 'PRIMARY', 'def', 'weather', 'danye', 'humidity', 6, NULL, NULL, NULL, NULL),
('def', 'weather', 'id', 'def', 'weather', 'danye', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-01-25 17:07:05', '2018-01-25 17:07:05', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-01-25 17:07:05', '2018-01-25 17:07:05', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-01-25 17:07:05', '2018-01-25 17:07:05', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-01-25 17:07:05', '2018-01-25 17:07:05', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-01-25 17:07:05', '2018-01-25 17:07:05', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-01-25 17:07:05', '2018-01-25 17:07:05', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-01-25 17:07:05', '2018-01-25 17:07:05', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-01-25 17:07:05', '2018-01-25 17:07:05', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-01-25 17:07:05', '2018-01-25 17:07:05', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2018-01-25 17:07:05', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 440, 1320, 123848989752688639, 5120, 0, '2012-05-15 12:23:04', '2018-01-10 11:06:32', '2012-05-15 12:23:07', NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 61, 308, 281474976710655, 2048, 0, '2012-05-15 12:23:04', '2018-01-10 11:06:32', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_bookmark', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_column_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_designer_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_history', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_pdf_pages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 48, 48, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2018-01-10 10:36:01', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_uiprefs', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_tracking', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 72, 72, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2018-01-10 16:19:21', NULL, NULL, '', '', NULL),
('def', 'weather', 'danye', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 32768, 0, '2018-01-10 10:35:51', NULL, NULL, NULL, '', '', NULL);
...
(60, 'root', 'localhost:2664', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(59, 'root', 'localhost:2663', NULL, 'Sleep', 1, '', NULL);
...
('def', 'weather', 'utf8', 'utf8_general_ci', NULL);
...
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'SELECT', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'INSERT', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'UPDATE', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'DELETE', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'CREATE', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'DROP', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'REFERENCES', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'INDEX', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'ALTER', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'CREATE TEMPORARY TABLES', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'LOCK TABLES', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'EXECUTE', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'CREATE VIEW', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'SHOW VIEW', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'CREATE ROUTINE', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'ALTER ROUTINE', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'EVENT', 'NO'),
('''sirenko''@''localhost''', 'def', 'sirenko\\_%', 'TRIGGER', 'NO'),
('''''@''%''', 'def', 'test', 'SELECT', 'NO'),
('''''@''%''', 'def', 'test', 'INSERT', 'NO'),
('''''@''%''', 'def', 'test', 'UPDATE', 'NO'),
('''''@''%''', 'def', 'test', 'DELETE', 'NO'),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3620'),
('INNODB_BUFFER_POOL_READS', '340'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1'),
('INNODB_DATA_FSYNCS', '7'),
...
('def', 'weather', 'danye', 0, 'weather', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'weather', 'danye', 0, 'weather', 'PRIMARY', 2, 'date_pogod', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'weather', 'danye', 0, 'weather', 'PRIMARY', 3, 'name_gorod', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'weather', 'danye', 0, 'weather', 'PRIMARY', 4, 'temperature', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'weather', 'danye', 0, 'weather', 'PRIMARY', 5, 'pressure', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'weather', 'danye', 0, 'weather', 'PRIMARY', 6, 'humidity', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'weather', 'danye', 0, 'weather', 'id', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'weather', 'danye', 1, 'weather', 'id_2', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-01-25 17:07:06', '2018-01-25 17:07:06', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-01-25 17:07:06', '2018-01-25 17:07:06', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-01-25 17:07:06', '2018-01-25 17:07:06', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-01-25 17:07:06', '2018-01-25 17:07:06', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-01-25 17:07:06', '2018-01-25 17:07:06', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-01-25 17:07:06', '2018-01-25 17:07:06', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-01-25 17:07:06', '2018-01-25 17:07:06', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-01-25 17:07:06', '2018-01-25 17:07:06', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-01-25 17:07:06', '2018-01-25 17:07:06', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2018-01-25 17:07:06', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
...
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 3, 440, 1320, 123848989752688639, 5120, 0, NULL, '2012-05-15 12:23:04', '2018-01-10 11:06:32', '2012-05-15 12:23:07', 'utf8_bin', NULL, '', 'Database privileges'),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 61, 308, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:04', '2018-01-10 11:06:32', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'phpmyadmin', 'pma_bookmark', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, '', 'Bookmarks'),
('def', 'phpmyadmin', 'pma_column_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, '', 'Column information for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_designer_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, '', 'Table coordinates for Designer'),
('def', 'phpmyadmin', 'pma_history', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, '', 'SQL history for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_pdf_pages', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, '', 'PDF relation pages for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 48, 48, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2018-01-10 10:36:01', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
('def', 'phpmyadmin', 'pma_relation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, '', 'Relation table'),
('def', 'phpmyadmin', 'pma_table_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, '', 'Table coordinates for phpMyAdmin PDF output'),
('def', 'phpmyadmin', 'pma_table_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, '', 'Table information for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_table_uiprefs', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, '', 'Tables'' UI preferences'),
('def', 'phpmyadmin', 'pma_tracking', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:25', NULL, 'utf8_bin', NULL, 'row_format=COMPACT', 'Database changes tracking for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 72, 72, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2018-01-10 16:19:21', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin'),
('def', 'weather', 'danye', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 32768, 7340032, 40, '2018-01-10 10:35:51', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
('def', 'weather', 'PRIMARY', 'weather', 'danye', 'PRIMARY KEY'),
('def', 'weather', 'id', 'weather', 'danye', 'UNIQUE');
...
('''sirenko''@''localhost''', 'def', 'SELECT', 'YES'),
('''sirenko''@''localhost''', 'def', 'INSERT', 'YES'),
('''sirenko''@''localhost''', 'def', 'UPDATE', 'YES'),
('''sirenko''@''localhost''', 'def', 'DELETE', 'YES'),
('''sirenko''@''localhost''', 'def', 'CREATE', 'YES'),
('''sirenko''@''localhost''', 'def', 'DROP', 'YES'),
('''sirenko''@''localhost''', 'def', 'RELOAD', 'YES'),
('''sirenko''@''localhost''', 'def', 'SHUTDOWN', 'YES'),
('''sirenko''@''localhost''', 'def', 'PROCESS', 'YES'),
('''sirenko''@''localhost''', 'def', 'FILE', 'YES'),
('''sirenko''@''localhost''', 'def', 'REFERENCES', 'YES'),
('''sirenko''@''localhost''', 'def', 'INDEX', 'YES'),
('''sirenko''@''localhost''', 'def', 'ALTER', 'YES'),
('''sirenko''@''localhost''', 'def', 'SHOW DATABASES', 'YES'),
('''sirenko''@''localhost''', 'def', 'SUPER', 'YES'),
('''sirenko''@''localhost''', 'def', 'CREATE TEMPORARY TABLES', 'YES'),
('''sirenko''@''localhost''', 'def', 'LOCK TABLES', 'YES'),
('''sirenko''@''localhost''', 'def', 'EXECUTE', 'YES'),
('''sirenko''@''localhost''', 'def', 'REPLICATION SLAVE', 'YES'),
('''sirenko''@''localhost''', 'def', 'REPLICATION CLIENT', 'YES'),
('''sirenko''@''localhost''', 'def', 'CREATE VIEW', 'YES'),
('''sirenko''@''localhost''', 'def', 'SHOW VIEW', 'YES'),
('''sirenko''@''localhost''', 'def', 'CREATE ROUTINE', 'YES'),
('''sirenko''@''localhost''', 'def', 'ALTER ROUTINE', 'YES'),
('''sirenko''@''localhost''', 'def', 'CREATE USER', 'YES'),
('''sirenko''@''localhost''', 'def', 'EVENT', 'YES'),
('''sirenko''@''localhost''', 'def', 'TRIGGER', 'YES'),
('''sirenko''@''localhost''', 'def', 'CREATE TABLESPACE', 'YES'),
...
('localhost', 'sirenko\\_%', 'sirenko', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
('localhost', 'sirenko', '*23AE809DDACAF96AF0FD78ED04B6A265E05AA257', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', NULL);
--
...
('root', '2018-01-10 16:19:16', '{"lang":"ru"}');
--
-- База данных: `weather`
--
