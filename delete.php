...
mysql_query(" DELETE FROM danye WHERE id='$id' ");
...
<form action="index1.php" method="get" id="action_form"> 
<input type="submit" name="button" class="button" onclick="form_submit();" value="На главную"/>
<a style="background-color: rgba(48,109,232,1); color: rgb(255, 255, 255); padding: 4px 10px; text-decoration: none; border-radius: 30px; " href="result.php">Вернуться назад</a>
</form>
</p>
</div>
<div id="footer">
